	...
	<div class="column rightsb">
				<div class="header_R" style="background:url({$gcms_3_pic}) no-repeat ;"></div>
				<!--  !-->
				...
				<div class="bg_mid_box4">
					<div class="txt">
					{if $g_t_login eq "admin"}
					مدیر کل {$g_name_login} خوش آمدید. <br />
					<b>ایجاد</b><br />
					...
					{/if}
					{if $g_t_login eq "shipman"}
					مدیر کشتیرانی {$g_name_login} <br /> خوش آمدید. <br />
					<b>ایجاد</b><br />
					...
					{/if}
					{if $g_t_login eq "portman"}
					مدیر بنادر {$g_name_login} <br /> خوش آمدید. <br />
					...
					{if $g_t_login eq "free"}
					کاربر گرامی {$g_name_login} <br /> خوش آمدید. <br />
                    اعتبار شما : {$u_amount} ريال<br />
					...
					{/if}
					{if $g_t_login eq "agency"}
					مدیر آژانس  <b>{$g_agency_name}</b> ،
					<em>{$g_name_login} </em>،
					 خوش آمدید. <br />
					<b>جستجو</b><br />
					...
					<br />
					{if $g_customer_name_buy }
					خرید برای مشتری قبلی : <br />
					 {$g_customer_name_buy} - <a href="?part=agency&agency=old&del=true">حذف از لیست خرید</a>
					<br />
					{/if}
					<br />
					کل اعتبار&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {$g_agency_credit} ریال  <br />
					اعتبار مصرفی&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {$g_agency_use} ریال  <br />
					باقی مانده اعتبار&nbsp;: {$baghimande_poll} ریال
					{/if}
					<br />
                ...
                <!-- box4 !-->
				<div class="bg_top_box4">
					<div class="title">{$gcms_5_title}</div>
				</div>
				<div class="bg_mid_box4">
					<div class="txt">
					{$gcms_5_content}
