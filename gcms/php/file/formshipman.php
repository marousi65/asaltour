...
$form_shipman_edit_profile = "

<form action='?part=shipman&shipman=edit&edit=profile&profile=chng' method='post' >
...
$form_shipman_edit_pass = "

<form action='?part=shipman&shipman=edit&edit=pass&passw=chng' method='post' >
<table id='formtable1'>
	<tr>
		<td>
		کلمه عبور جدید
...
$form_shipman_new_psngrtrade = "

<form action='?part=shipman&shipman=new&new=psngrtrade&psngrtrade=true' method='post' >
...
<tbody>
	...
	درصد  کنسلی بلیط
		...
		<td>
		<input type='text' name='darsad_cancel' value='$_REQUEST[darsad_cancel]'  class='reqd' />
		</td>
	</tr>
...
$magh = "<select name='magh' >";
while ($row_mabmagh_1 = mysql_fetch_array($res_mabmagh_1)){
if ($row_mabmagh_1[id] == $row_1[22]){ $selct1 = " selected='selected' ";	}else{$selct1 = "" ;}
if ($row_mabmagh_1[id] == $row_1[24]){ $selct2 = " selected='selected' ";	}else{$selct2 = "" ;}
...
if ($arrsailiglist[$i]){
$r_taksailiglist =  mysql_fetch_array(mysql_query(" SELECT name FROM `gcms_sailing` WHERE `id` = '$arrsailiglist[$i]' ",$link));
if ($arrsailiglist[$i] == $row_1[20]){ $selct3 = " selected='selected' ";	}else{$selct3 = "" ;}
...
$form_shipman_edit_psngrtrade = "

<form action='?part=shipman&shipman=edit&edit=psngrtrade&id=$_REQUEST[id]&psngrtrade=chng' method='post' >
<table id='hor-minimalist-a-2'  >
<tbody>
	<tr>
		<td>
	...
	درصد کنسلی بلیط
		...
		<td>
	<input type='text' name='darsad_cancel' value='$row_1[darsad_cancel]' class='reqd' />
		</td>
	</tr>
	<tr>
		<td>
...
$form_shipman_new_cartrade = "

<form action='?part=shipman&shipman=new&new=cartrade&cartrade=true' method='post' >
<table id='hor-minimalist-a-2'  >
<tbody>
	<tr>
		<td>
...
$form_shipman_new_car = "

<form action='?part=shipman&shipman=new&new=car&car=true' method='post' >
<table id='hor-minimalist-a-2'  >
<tbody>
	<tr>
		<td>
...
$form_shipman_edit_cartrade = "

<form action='?part=shipman&shipman=edit&edit=cartrade&id=$_REQUEST[id]&cartrade=chng' method='post' >
<table id='hor-minimalist-a-2'  >
<tbody>
	<tr>
		<td>
	...
	درصد کنسلی بلیط
		...
		<td>
	<input type='text' name='darsad_cancel' value='$row_1[19]' class='reqd' />
		</td>
	</tr>
	<tr>
		<td>
