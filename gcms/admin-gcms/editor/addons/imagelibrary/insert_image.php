...
if($allowuploads && $_FILES['file']) {
	...
	$ttime = time();
	$filetypesize = $_FILES['file']['size'];
	// add to table
		$que_addtopic = "INSERT INTO `gcms_file` ( `file_name` ,`file_type` ,`file_size` ,`folder` ,`date` ,`user` ) VALUES ('$source' ,'Image.png' ,'$filetypesize' ,'editorpic' ,'$ttime' ,'$_SESSION[initiated]')";
		$res_addtopic= mysql_query($que_addtopic,$link);
	// gatriya code end
